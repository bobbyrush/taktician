...
3. **Build the Electron app**
   ...
   - The build process automatically:
     - Uses the version from `package.json` for artifact names (e.g., `Taktician-1.2.3-x64.zip`)
...
- Build artifact names (e.g., `Taktician-1.2.3-x64.zip`)
- App UI display (shown as `v1.2.3` below the logo in `apps/ui/src/components/layout/sidebar/components/taktician-logo.tsx`)
