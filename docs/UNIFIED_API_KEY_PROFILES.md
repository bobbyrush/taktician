...
Claude Compatible Providers allow Taktician to work with third-party API endpoints that implement Claude's API protocol. This enables:
...
Project overrides are stored in `.taktician/settings.json`:
