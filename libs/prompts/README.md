...
AI prompt templates for text enhancement and other AI-powered features in Taktician.
...
```typescript
import { getSystemPrompt } from '@taktician/prompts';
...
```typescript
import { getExamples } from '@taktician/prompts';
...
```typescript
import { buildUserPrompt } from '@taktician/prompts';
...
```typescript
import { isValidEnhancementMode } from '@taktician/prompts';
...
```typescript
import { getAvailableEnhancementModes } from '@taktician/prompts';
...
```typescript
import { isValidEnhancementMode, getAvailableEnhancementModes } from '@taktician/prompts';
...
```typescript
import { getSystemPrompt, buildUserPrompt, getExamples } from '@taktician/prompts';
...
- `@taktician/types` - Type definitions for EnhancementMode and EnhancementExample

## Used By

- `@taktician/server` - Enhancement API routes
