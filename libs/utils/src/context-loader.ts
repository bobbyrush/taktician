 ...
 *
 * Provides a shared utility to load context files from .taktician/context/
 * and memory files from .taktician/memory/, formatting them as system prompt
 ...
 * Stored in {projectPath}/.taktician/context/context-metadata.json
 */
...
/**
 * Memory file info (from .taktician/memory/)
 */
 ...
 * Compatible with secureFs from @taktician/platform
...
export interface LoadContextFilesOptions {
  ...
  /** Whether to include context files from .taktician/context/ (default: true) */
  includeContextFiles?: boolean;
  /** Whether to include memory files from .taktician/memory/ (default: true) */
...
function getContextDir(projectPath: string): string {
  return path.join(projectPath, '.taktician', 'context');
}
...
/**
 * Load context files from a project's .taktician/context/ directory
 * and optionally memory files from .taktician/memory/
 *
