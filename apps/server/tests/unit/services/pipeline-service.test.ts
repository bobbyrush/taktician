...
import type { PipelineConfig, PipelineStep } from '@taktician/types';
...
// Mock ensureTakticianDir
vi.mock('@taktician/platform', () => ({
  ensureTakticianDir: vi.fn(),
}));

import * as secureFs from '@/lib/secure-fs.js';
import { ensureTakticianDir } from '@taktician/platform';
...
describe('pipeline-service.ts', () => {
  ...
  describe('getPipelineConfig', () => {
    ...
    it('should read and return existing config', async () => {
      ...
      const configPath = path.join(testProjectDir, '.taktician', 'pipeline.json');
  ...
  describe('savePipelineConfig', () => {
    it('should save config to file', async () => {
      ...
      vi.mocked(ensureTakticianDir).mockResolvedValue(undefined);
      ...
      expect(ensureTakticianDir).toHaveBeenCalledWith(testProjectDir);
