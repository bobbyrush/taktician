...
import * as imageHandler from '@taktician/utils';
import * as promptBuilder from '@taktician/utils';
import * as contextLoader from '@taktician/utils';
...
describe('agent-service.ts', () => {
  ...
  describe('createSession', () => {
    ...
    it('should validate working directory', async () => {
      ...
      vi.resetModules();
      const { initAllowedPaths } = await import('@taktician/platform');
      initAllowedPaths();
      ...
      vi.resetModules();
      const { initAllowedPaths: reinit } = await import('@taktician/platform');
      reinit();
    });
  });
