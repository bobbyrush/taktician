...
const isTestMode = process.env.TAKTICIAN_MOCK_AGENT === 'true';
...
export function createAuthRoutes(): Router {
   ...
   *
   * If TAKTICIAN_AUTO_LOGIN=true is set, automatically creates a session
  ...
  router.get('/status', async (req, res) => {
    ...
    if (
      !authenticated &&
      process.env.TAKTICIAN_AUTO_LOGIN === 'true' &&
