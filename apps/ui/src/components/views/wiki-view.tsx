  ...
  const sections: WikiSection[] = [
    {
      ...
      content: (
        <div className="space-y-3">
          <p>
            <strong className="text-foreground">Taktician</strong> is an autonomous AI development
            studio that helps developers build software faster using AI agents.
          </p>
          <p>
            At its core, Taktician provides a visual Kanban board to manage features. When you're
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>Taktician is built as a monorepo with two main applications and shared libraries:</p>
          ...
          <div className="mt-4 space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li>Shared monorepo packages (@taktician/*) for code reuse</li>
            </ul>
          </div>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>Here's what happens when you use Taktician to implement a feature:</p>
            ...
            <li className="text-foreground">
              ...
              <p className="text-muted-foreground ml-5 mt-1">
                ...
                <code className="px-1 py-0.5 bg-muted rounded text-xs">
                  .taktician/features/&#123;id&#125;/feature.json
                </code>
              </p>
            </li>
            <li className="text-foreground">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-3">The Taktician codebase is organized as follows:</p>
...
`}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>The main UI components that make up Taktician:</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>
            Taktician stores project configuration in the{' '}
            <code className="px-1 py-0.5 bg-muted rounded text-xs">.taktician/</code> directory:
          </p>
          <div className="grid gap-2 mt-4">
            {[
              {
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>Follow these steps to start building with Taktician:</p>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Learn how Taktician works and how to use it effectively
            </p>
          </div>
