...
// Re-export getErrorMessage from @taktician/utils to maintain backward compatibility
...
// (the main @taktician/utils barrel imports modules that depend on @taktician/platform)
export { getErrorMessage } from '@taktician/utils/error-handler';
