...
try {
  ...
  const uiNewVersion = bumpVersion(uiPackageJsonPath, '@taktician/ui');
  ...
  const serverNewVersion = bumpVersion(serverPackageJsonPath, '@taktician/server');
  ...
  console.log(`📦 Updated @taktician/ui: ${uiOldVersion} -> ${uiNewVersion}`);
  console.log(`📦 Updated @taktician/server: ${serverOldVersion} -> ${serverNewVersion}`);
