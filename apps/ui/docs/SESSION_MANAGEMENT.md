...
The Taktician Agent Chat now supports multiple concurrent sessions, allowing you to organize different conversations by topic, feature, or task. Each session is independently managed and persisted.
...
```
~/Library/Application Support/taktician/agent-sessions/
```

**Windows:**

```
%APPDATA%/taktician/agent-sessions/
```

**Linux:**

```
~/.config/taktician/agent-sessions/
```
...
ls -la ~/Library/Application\ Support/taktician/

# Fix permissions if needed
chmod -R u+w ~/Library/Application\ Support/taktician/
```
