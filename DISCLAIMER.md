...
**Taktician uses AI-powered tooling that has access to your operating system and can read, modify, and delete files. Use at your own risk.**
...
Before running Taktician, we strongly recommend reviewing the source code yourself to understand what operations it performs and ensure you are comfortable with its behavior.

### 2. Use Sandboxing (Highly Recommended)

**We do not recommend running Taktician directly on your local computer** due to the risk of AI agents having access to your entire file system. Instead, consider:

- **Docker**: Run Taktician in a Docker container to isolate it from your host system
...
For maximum security, run Taktician in an isolated Docker container that **cannot access your laptop's files**:
...
By using Taktician, you acknowledge that:
